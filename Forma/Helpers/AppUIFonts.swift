...
enum Typography {
    ...
    case buttonLarge, buttonMedium, label, caption, overline
    case monospacedLarge, monospacedMedium, monospacedSmall
    case displayThin, displayThinLarge, wordmark, microTracked, ultraLight, ultraLightSmall
    ...
    var lineHeight: CGFloat {
        ...
        case .bodyLarge, .monospacedLarge: return 24
        case .bodyMedium, .monospacedMedium: return 22
        case .bodySmall, .monospacedSmall: return 20
        case .buttonLarge, .buttonMedium, .label: return 20
        case .caption, .overline: return 16
...
extension NSAttributedString {
    static func styled(_ text: String, typography: Typography, color: UIColor = .label, alignment: NSTextAlignment = .left) -> NSAttributedString {
